...
class Simulated_User():
    ...
    def converse_with_user(self, question_to_user, use_llm=True):
        ...
        if use_llm:
            ...
            if target_attr in self.latent_variables:
                val = self.latent_variables[target_attr]
                if val > 0.7:
                    return f"Yes, {target_attr} is extremely important to me."
                elif val < 0.3:
                    return f"To be honest, I don't care much about {target_attr}."
                else:
                    return f"I have a moderate preference for {target_attr}."
            ...
            # Fetch the list of 5 possible responses for this specific value
